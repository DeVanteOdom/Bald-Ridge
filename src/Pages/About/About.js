...
class About extends Component {
    constructor(props) {
        ...
        this.state = { 
            ...
            missionstatement: [ "Our mission is to provide a safe haven and counselling in a theraputic enviorment for boys who are in need of protection, direction, and supervision, in a manner that nurtures the child, strengthens family relationships and allows the community to care for their own."],
    ...
    render() {
        ...
        <p>{this.state.description}</p>
         ...
         <iframe src="https://player.vimeo.com/video/540830960" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
